        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <a href=" " ><img src="assets/img/courses/btech.png "width="400px" height="250px" alt="..."></a>
              <div class="course-content">
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  ...
                  <div class="trainer-rank d-flex align-items-center">
                    <i class="bx bx-user"></i>&nbsp;1.2k
                    &nbsp;&nbsp;
                    <i class="bx bx-heart"></i>&nbsp;500
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              <a href=" " ><img src="assets/img/courses/mtech.jpg" width="400px" height="250px"alt="..."></a>           
                 <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>M.tech</h4>
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  ...
                  <div class="trainer-rank d-flex align-items-center">
                    <i class="bx bx-user"></i>&nbsp;1.3k+
                    &nbsp;&nbsp;
                    <i class="bx bx-heart"></i>&nbsp;700
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="course-item">
              <a href=" " ><img src="assets/img/courses/phd.jpeg"width="400px" height="250px"  alt="..."></a>       
                     <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>PHD</h4>
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                  ...
                  <div class="trainer-rank d-flex align-items-center">
                    <i class="bx bx-user"></i>&nbsp;1k+
                    &nbsp;&nbsp;
                    <i class="bx bx-heart"></i>&nbsp;900
                  </div>
                </div>
              </div>
            </div>
